window.DT_LOCALES = {}, window.DT_LOCALES.it = {
    SEARCH: "cerca",
...
class DataTable {
    constructor(e) {
        this.el = e, this.data = [], this.filtered = [], this.currPage = 1, this.perPage = 5, this.locale = {}
    }
    checkId() {
    ...
    init() {
        ...
        for (let e = 1; e <= 5; e++) a.innerHTML += `<option ${1==e?"selected":""} value='${5*e}'>\n                    ${5*e}\n                </option>`;
        if (a.onchange = (() => {
